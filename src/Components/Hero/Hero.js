                ...
                <div className="col-md-7 col-lg-6">
                    <div className="d-flex justify-content-center">
                        <div  className="hero-content  text-center">
                            ...
                            <div data-aos-delay="500" data-aos="zoom-in-up"  data-aos-duration="800" data-aos-anchor-placement="top-bottom" class="description"><p>Lorem Ipsum is simply dummy text of the printing and typesetting industry
                            </p></div>
                ...
                <div className="col-md-5 col-lg-6">
                    <div className="d-flex justify-content-end">
                        <div data-aos-delay="500" data-aos="zoom-in"  data-aos-duration="900" className="hero-image text-center">
                            <img className="light w-100" src="hero-infographic.svg" />
                            <img className="dark w-100" src="hero-infographic1.svg" />
                        </div>
                     </div>
                </div>
             </div>
